...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-warning justify-content-between"
        ...
        <a class="navbar-brand" style="padding: 10px">
            <div style="font-size: 30px">Maintenance question and rating</div>
        </a>
        <ul class="navbar-nav">
        <li class="navbar-link">
                <button class="btn btn-outline-danger btn-lg" style="margin-right: 10px"
                    onclick="location.href = 'MaintenanceLevel.php';">Change Level</button>
            </li>
            <li class="navbar-link">
                <button class="btn btn-outline-danger btn-lg" style="margin-right: 10px"
    ...
    foreach ($sections as $section) {
        ...
        foreach ($questions as $question) {
            ...
            echo '</td>';
            echo '<td>';
            echo '<a href="ChangeQuestionRating.php?id=' . $sectionid . '/' . $questionid . '">Change</a>';
            echo '</td></tr>';
